...
# VLC 2.2.2 isn't compatible with the current ffmpeg 3.0; then libav works fine
%if 0%{?fedora} >= 24
%bcond_with ffmpeg
%bcond_without libav 
%else
...
# VLC 2.2.2 isn't fully compatible with qt5
%bcond_without qt4 
%bcond_with qt5 
...
%endif
%{?fc24:BuildRequires: freerdp1-devel}
%{?fc23:BuildRequires: freerdp1-devel}
...
# The current ProjectM isn't compatible with vlc 2.2.2 (fc24)
%if 0%{?fedora} <= 23
